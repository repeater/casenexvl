...
function cmb_qcopd_dir_fields( array $meta_boxes ) {
	...
	$qcopd_item_fields = array(
		array( 'id' => 'qcopd_item_title',  'name' => 'Item Title', 'type' => 'text', 'cols' => 6, 'desc' => 'Title of the list item' ),
		array( 'id' => 'qcopd_item_link',  'name' => 'Item Link', 'type' => 'text', 'cols' => 6, 'desc' => 'With http://, Example: http://www.google.com' ),
