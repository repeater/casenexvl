...
if( !class_exists('Qcrating') ){
	...
	class Qcrating{
		...
		private function review_dismissal() {
			...
			add_site_option( 'qc_'.$this->plugin_name.'_rating_dismiss', 'yes' );
		}
		...
		function review_prending() {
			...
			update_site_option( 'qc_'.$this->plugin_name.'_rating_active_time', time() );
		...
		public function qc_admin_notice_rating(){
			...
			$activation_time 	= get_site_option( 'qc_'.$this->plugin_name.'_rating_active_time' );
			$review_dismissal	= get_site_option( 'qc_'.$this->plugin_name.'_rating_dismiss' );
			...
			if ( ! $activation_time ) {
				...
				add_site_option( 'qc_'.$this->plugin_name.'_rating_active_time', $activation_time );
			}
		...
		?>
			<div class="qc-review-notice">
				<div class="qc-review-thumbnail">
					<img src="<?php echo $this->logo_url; ?>" alt="">
				</div>
				...
				<div class="qc-review-text">
					...
					<ul class="qc-review-ul">
						...
						<li><a href="<?php echo $this->plugin_rating_url; ?>" target="_blank"><span class="dashicons dashicons-star-filled"></span><?php _e( 'Leave A Review', 'qc-sld' ) ?></a></li>
						 <li><a href="<?php echo $dismiss_url ?>"><span class="dashicons dashicons-yes"></span><?php _e( 'I\'ve already left a review', 'qc-sld' ) ?></a></li>
						 <li><a href="<?php echo $later_url ?>"><span class="dashicons dashicons-calendar"></span><?php _e( 'Maybe Later', 'qc-sld' ) ?></a></li>
						 <li><a href="<?php echo $dismiss_url ?>"><span class="dashicons dashicons-no"></span><?php _e( 'Never show this again', 'qc-sld' ) ?></a></li>
