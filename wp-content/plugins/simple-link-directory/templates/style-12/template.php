...
<?php wp_enqueue_style('sld-css-style-12', OCOPD_TPL_URL . "/$template_code/template.css" ); ?>
...
<style>
			#bookmark_list.style-12 h2{
				background: <?php echo $conf['list_border_color']; ?>;
			}
			
			#bookmark_list.style-12 ul.sld-list li{
				<?php if( $conf['item_bdr_color'] != "" ) : ?>
				border-bottom: 1px solid <?php echo $conf['item_bdr_color']; ?>;
				<?php endif; ?>
			}

			#bookmark_list.style-12 li{
			    background-color: <?php echo $conf['list_bg_color']; ?>;
			    <?php if( $conf['item_bdr_color'] != "" ) : ?>
				border-color: -moz-use-text-color -moz-use-text-color <?php echo $conf['item_bdr_color']; ?> !important;
				<?php endif; ?>
			}

			#bookmark_list.style-12 li:hover {
			    background-color: <?php echo $conf['list_bg_color_hov']; ?>;
				color: <?php echo $conf['list_txt_color_hov']; ?>;
				<?php if( $conf['item_bdr_color'] != "" ) : ?>
				border-color: -moz-use-text-color -moz-use-text-color <?php echo $conf['list_bg_color_hov']; ?> !important;
				<?php endif; ?>
			}

			#bookmark_list.style-12 li a{
			...
			#bookmark_list.style-12 li:hover a{
			  color: <?php echo $conf['list_txt_color_hov']; ?>;
			}

			#bookmark_list.style-12 li .upvote-section .upvote-btn, #bookmark_list.style-12 .ca-menu li .upvote-section .upvote-count{
			  color: <?php echo $conf['list_subtxt_color']; ?>;
			}		

			#bookmark_list.style-12 li:hover .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-12 li:hover .upvote-section .upvote-count{
		...
		<div id="bookmark_list" class="qc-grid-item qcopd-list-column opd-column-<?php echo $column; echo " " . $style;?> <?php echo "opd-list-id-" . get_the_ID(); ?>">
			...
			<div class="opd-list-style-12 sld-container">
			
				<h2><?php echo ($b_title!=''?$b_title:'Quick Links'); ?></h2>
				<ul class="tooltip_tpl12-tpl sld-list" id="sld_bookmark_ul">
			...
			if(!empty($user_meta_data)){
				foreach($user_meta_data[0] as $postid=>$metaids){
					...
					<li id="sld_bookmark_li_<?php echo $b; ?>">
						...
						<?php 
	                        ...
	                        $toolipsetup = 'class="tooltip-element tooltip_tpl8 fade" data-title="'.trim($list['qcopd_item_subtitle']).'"';
							}else{
								$toolipsetup = '';
							}
						?>
				...
				<!-- navigation panel -->
				<div id="jp-holder-<?php echo get_the_ID(); ?>" class="sldp-holder"></div>
...
//adding extra variable in config
		...
		<style>
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-12 h2{
				background: <?php echo $conf['list_border_color']; ?>;
			}
			
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-12 ul.sld-list li{
				<?php if( $conf['item_bdr_color'] != "" ) : ?>
				border-bottom: 1px solid <?php echo $conf['item_bdr_color']; ?>;
				<?php endif; ?>
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-12 li{
			    background-color: <?php echo $conf['list_bg_color']; ?>;
			    <?php if( $conf['item_bdr_color'] != "" ) : ?>
				border-color: -moz-use-text-color -moz-use-text-color <?php echo $conf['item_bdr_color']; ?> !important;
				<?php endif; ?>
			...
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-12 li:hover {
			    background-color: <?php echo $conf['list_bg_color_hov']; ?>;
				color: <?php echo $conf['list_txt_color_hov']; ?>;
				<?php if( $conf['item_bdr_color'] != "" ) : ?>
				border-color: -moz-use-text-color -moz-use-text-color <?php echo $conf['list_bg_color_hov']; ?> !important;
			...
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-12 li a{
			  color: <?php echo $conf['list_txt_color']; ?>;
			  <?php if($conf['item_title_font_size']!=''): ?>
				font-size:<?php echo $conf['item_title_font_size']; ?> !important;
				<?php endif; ?>
			...
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-12 li:hover a{
			  color: <?php echo $conf['list_txt_color_hov']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-12 li .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-12 .ca-menu li .upvote-section .upvote-count{
			  color: <?php echo $conf['list_subtxt_color']; ?>;
			}		

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-12 li:hover .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-12 li:hover .upvote-section .upvote-count{
			  color: <?php echo $conf['list_subtxt_color_hov']; ?>;
			}
			
			#item-<?php echo $listId .'-'. get_the_ID(); ?>-add-block .advertise-block.tpl-default{
				border: 1px solid #dedede;
				border-bottom: 2px solid <?php echo $conf['item_bdr_color']; ?>;
			}
		...
		<div id="qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>" class="qc-grid-item qcopd-list-column opd-column-<?php echo $column; echo " " . $style;?> <?php echo "opd-list-id-" . get_the_ID(); ?>">
			...
			<div class="opd-list-style-12 sld-container qcopd-single-list">
				...
				<ul class="tooltip_tpl12-tpl sld-list" id="jp-list-<?php echo get_the_ID(); ?><?php echo (isset($cattabid)&&$cattabid!=''?'-'.$cattabid:''); ?>">
					<?php $count = 1; 
						if( $item_orderby == 'upvotes' )
						{
    						usort($lists, "custom_sort_by_tpl_upvotes");
					...
					<li id="item-<?php echo get_the_ID() ."-". $count; ?>">
						...
						<?php if( $upvote == 'on' ) : ?>
							...
							<!-- upvote section -->
							<div class="upvote-section upvote-section-style-12">
