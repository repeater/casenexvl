...
<?php wp_enqueue_style('sld-css-style-8', OCOPD_TPL_URL . "/$template_code/template.css" ); ?>
...
<style>
			...
			#bookmark_list.style-8 .tooltip_tpl8:after {
			  border-bottom: 6px solid <?php echo $conf['list_txt_color_hov']; ?>;
			}

			#bookmark_list.style-8 li .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-8 .ca-menu li .upvote-section .upvote-count{
			  color: <?php echo $conf['list_subtxt_color']; ?>;
			}

			#bookmark_list.style-8 li:hover .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-8 li:hover .upvote-section .upvote-count{
		...
		<div id="bookmark_list" class="qc-grid-item qcopd-list-column opd-column-<?php echo $column; echo " " . $style;?> <?php echo "opd-list-id-" . get_the_ID(); ?>">
			...
			<div class="opd-list-style-8">
				...
				<ul class="tooltip_tpl8-tpl" id="sld_bookmark_ul">
			...
			if(!empty($user_meta_data)){
				foreach($user_meta_data[0] as $postid=>$metaids){
					...
					<li id="sld_bookmark_li_<?php echo $b; ?>">
						...
						<div class="bookmark-section-style-8">
...
//adding extra variable in config
		...
		<style>
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-8 h3:after{
				border-bottom: 2px solid <?php echo $conf['item_bdr_color']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-8 li a {
			    background-color: <?php echo $conf['list_bg_color']; ?>;
			    border-color: -moz-use-text-color -moz-use-text-color <?php echo $conf['item_bdr_color']; ?> !important;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-8 li a:hover {
			    background-color: <?php echo $conf['list_bg_color_hov']; ?>;
				color: <?php echo $conf['list_txt_color_hov']; ?>;
				border-color: -moz-use-text-color -moz-use-text-color <?php echo $conf['list_bg_color_hov']; ?> !important;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-8 li a .li-txt {
			  color: <?php echo $conf['list_txt_color']; ?>;
				<?php if($conf['item_title_font_size']!=''): ?>
				font-size:<?php echo $conf['item_title_font_size']; ?> !important;
				<?php endif; ?>
			...
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-8 li a:hover .li-txt {
			  color: <?php echo $conf['list_txt_color_hov']; ?>;

			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-8 .tooltip_tpl8:before {
			  color: <?php echo $conf['list_subtxt_color']; ?>;
				<?php if($conf['item_subtitle_font_size']!=''): ?>
				font-size:<?php echo $conf['item_subtitle_font_size']; ?> !important;
				<?php endif; ?>
			...
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-8 .tooltip_tpl8:after {
			  border-bottom: 6px solid <?php echo $conf['list_txt_color_hov']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-8 li .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-8 .ca-menu li .upvote-section .upvote-count{
			  color: <?php echo $conf['list_subtxt_color']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-8 li:hover .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-8 li:hover .upvote-section .upvote-count{
			  color: <?php echo $conf['list_subtxt_color_hov']; ?>;
			}
