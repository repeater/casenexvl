...
<?php wp_enqueue_style('sld-css-style-14-responsive', OCOPD_TPL_URL . "/$template_code/responsive.css" ); ?>
		...
		<div id="bookmark_list" class="qc-grid-item qcopd-list-column opd-column-<?php echo 1; echo " " . $style;?> <?php echo "opd-list-id-" . get_the_ID(); ?>">
			...
			<div class="opd-list-style-12 sld-container title_style_sld" style="<?php echo ($listId==1)?'margin-top:10px':''; ?>">
				...
				<div class="main-title">
                            <h2 <?php echo (isset($conf['list_title_color'])&&$conf['list_title_color']!=''?'style="color:'.$conf['list_title_color'].';"':''); ?>><?php echo ($b_title!=''?$b_title:'Quick Links'); ?>
			...
			if(!empty($user_meta_data)){
				foreach($user_meta_data[0] as $postid=>$metaids){
					...
					<li id="sld_bookmark_li_<?php echo $b; ?>" class="sld-26">
						<?php
						...
						?>
                            	<div class="column-grid<?php echo $column; ?>">
                                	<div class="sld-main-content-area bg-color-0<?php echo (($b%5)+1); ?>">
										...
										<div class="style-14-upvote-section">
                                            ...
                                            <a <?php if( $mask_url == 'on') { echo 'onclick="document.location.href = \''.$item_url.'\'; return false;"'; } ?> <?php echo (isset($list['qcopd_item_nofollow']) && $list['qcopd_item_nofollow'] == 1) ? 'rel="nofollow"' : ''; ?> href="<?php echo $masked_url; ?>" <?php echo (isset($list['qcopd_item_newtab']) && $list['qcopd_item_newtab'] == 1) ? 'target="_blank"' : ''; ?> ><?php echo $visit_page; ?></a>
                                        </div>
                                    </div>
                                </div>
                    </li>
