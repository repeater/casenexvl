...
<?php wp_enqueue_style('sld-css-style-10', OCOPD_TPL_URL . "/$template_code/template.css" ); ?>
<?php
...
<style>
			#bookmark_list.style-10 ul li .effect-style-seven{
			    background-color: <?php echo $conf['list_bg_color']; ?>;
				box-shadow: 1px 1px 2px <?php echo $conf['item_bdr_color']; ?>;
			}

			#bookmark_list.style-10 ul li:hover .effect-style-seven{
			...
			#bookmark_list.style-10 ul li h3 {
			...
			#bookmark_list.style-10 ul li:hover h3 {
			  color: <?php echo $conf['list_txt_color_hov']; ?>;
			}

			#bookmark_list.style-10 ul li p {
			...
			#bookmark_list.style-10 ul li:hover p {
			  color: <?php echo $conf['list_subtxt_color_hov']; ?>;
			}

			#bookmark_list.style-10 ul li .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-10 ul li .upvote-section .upvote-count{
			  color: <?php echo $conf['list_subtxt_color']; ?>;
			}

			#bookmark_list.style-10 ul li:hover .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-10 ul li:hover .upvote-section .upvote-count{
			  color: <?php echo $conf['list_subtxt_color_hov']; ?>;
			}
		...
		<div id="bookmark_list" class="qcopd-list-column <?php echo $style; ?>">
				...
				<section class="list-section-seven">
			        <div class="container-style-10">
			            <div class="row-style-10">
			                <ul class="portfolio-listing" id="sld_bookmark_ul">
			...
			if(!empty($user_meta_data)){
				foreach($user_meta_data[0] as $postid=>$metaids){
					...
					?>
                    <li id="sld_bookmark_li_<?php echo $b; ?>"  class="list-style-seven listy-style-seven-01 sld-style10-column<?php echo $column; ?>">
						<?php
						...
						<a <?php if( $mask_url == 'on') { echo 'onclick="document.location.href = \''.$item_url.'\'; return false;"'; } ?> <?php echo (isset($list['qcopd_item_nofollow']) && $list['qcopd_item_nofollow'] == 1) ? 'rel="nofollow"' : ''; ?> href="<?php echo $masked_url; ?>" <?php echo (isset($list['qcopd_item_newtab']) && $list['qcopd_item_newtab'] == 1) ? 'target="_blank"' : ''; ?> >
                            <div class="list-inner-part-seven">
								...
								<?php else : ?>
									<span class="ca-icon list-img-1" style="background-image: url(<?php echo QCOPD_IMG_URL; ?>/list-image-placeholder.png);">
									</span>
								<?php endif; ?>
...
//adding extra variable in config
		...
		<style>
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-10 ul li .effect-style-seven{
			    background-color: <?php echo $conf['list_bg_color']; ?>;
				box-shadow: 1px 1px 2px <?php echo $conf['item_bdr_color']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-10 ul li:hover .effect-style-seven{
			    background-color: <?php echo $conf['list_bg_color_hov']; ?>;
				color: <?php echo $conf['list_txt_color_hov']; ?>;
				box-shadow: 1px 1px 2px <?php echo $conf['item_bdr_color_hov']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-10 ul li h3 {
			  color: <?php echo $conf['list_txt_color']; ?>;
				<?php if($conf['item_title_font_size']!=''): ?>
				font-size:<?php echo $conf['item_title_font_size']; ?> !important;
				<?php endif; ?>
			...
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-10 ul li:hover h3 {
			  color: <?php echo $conf['list_txt_color_hov']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-10 ul li p {
			  color: <?php echo $conf['list_subtxt_color']; ?>;
				<?php if($conf['item_subtitle_font_size']!=''): ?>
				font-size:<?php echo $conf['item_subtitle_font_size']; ?> !important;
				<?php endif; ?>
			...
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-10 ul li:hover p {
			  color: <?php echo $conf['list_subtxt_color_hov']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-10 ul li .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-10 ul li .upvote-section .upvote-count{
			  color: <?php echo $conf['list_subtxt_color']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-10 ul li:hover .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-10 ul li:hover .upvote-section .upvote-count{
			  color: <?php echo $conf['list_subtxt_color_hov']; ?>;
			}
