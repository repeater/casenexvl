<?php wp_enqueue_style('sld-css-style-3', OCOPD_TPL_URL . "/$template_code/template.css" ); ?>
		...
		<div id="bookmark_list" class="<?php echo $style; ?>">
			...
			if(!empty($user_meta_data)){
				foreach($user_meta_data[0] as $postid=>$metaids){
					...
					?>
					<li id="sld_bookmark_li_<?php echo $b; ?>" class="column<?php echo $column; ?>">
						<?php
...
//adding extra variable in config
		...
		<style>
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-3 .ca-menu li {
			    background-color: <?php echo $conf['list_bg_color']; ?>;
				box-shadow: 1px 1px 2px <?php echo $conf['item_bdr_color']; ?>;
				border-top: 6px solid <?php echo $conf['list_txt_color']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-3 .ca-menu li:hover {
				...
				border-top: 6px solid <?php echo $conf['list_txt_color_hov']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-3 .ca-menu li .ca-main {
			...
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-3 .ca-menu li:hover .ca-main {
			  color: <?php echo $conf['list_txt_color_hov']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-3 .ca-menu li .ca-sub {
			...
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-3 .ca-menu li:hover .ca-sub {
			  color: <?php echo $conf['list_subtxt_color_hov']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-3 .ca-menu li:hover .upvote-section {
			  color: <?php echo $conf['list_subtxt_color_hov']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-3 .ca-menu li .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-3 .ca-menu li .upvote-section .upvote-count{
			  color: <?php echo $conf['list_subtxt_color']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-3 .ca-menu li:hover .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-3 .ca-menu li:hover .upvote-section .upvote-count{
			  color: <?php echo $conf['list_subtxt_color_hov']; ?>;
			}
		...
		<div id="qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>" class="<?php echo $style; ?>">
			...
			<div class="qcopd-single-list">
				...
				<ul class="ca-menu" id="jp-list-<?php echo get_the_ID(); ?><?php echo (isset($cattabid)&&$cattabid!=''?'-'.$cattabid:''); ?>">
					...
					?>
					<li id="item-<?php echo get_the_ID() ."-". $count; ?>" class="column<?php echo $column; ?>">
						<?php
							$item_url = $list['qcopd_item_link'];
							$masked_url = $list['qcopd_item_link'];
