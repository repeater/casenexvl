...
<?php wp_enqueue_style('sld-css-style-7', OCOPD_TPL_URL . "/$template_code/template.css" ); ?>
		...
		<div id="bookmark_list" class="qcopd-list-column <?php echo $style; ?>">
			...
			if(!empty($user_meta_data)){
				foreach($user_meta_data[0] as $postid=>$metaids){
					...
					<div class="style-7-upvote-section">
						<div class="bookmark-section bookmark-section-style-7">
...
//adding extra variable in config
		...
		<style>
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-7 .ca-menu li {
			    background-color: <?php echo $conf['list_bg_color']; ?>;
				box-shadow: 1px 1px 2px <?php echo $conf['item_bdr_color']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-7 .ca-menu li:hover {
			...
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-7 .ca-menu li .ca-main {
			...
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-7 .ca-menu li:hover .ca-main {
			  color: <?php echo $conf['list_txt_color_hov']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-7 .ca-menu li .ca-sub {
			...
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-7 .ca-menu li:hover .ca-sub {
			  color: <?php echo $conf['list_subtxt_color_hov']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-7 .ca-menu li .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-7 .ca-menu li .upvote-section .upvote-count{
			  color: <?php echo $conf['list_subtxt_color']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-7 .ca-menu li:hover .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-7 .ca-menu li:hover .upvote-section .upvote-count{
			  color: <?php echo $conf['list_subtxt_color_hov']; ?>;
			}
				...
				<ul class="ca-menu" id="jp-list-<?php echo get_the_ID(); ?><?php echo (isset($cattabid)&&$cattabid!=''?'-'.$cattabid:''); ?>">
					...
					<div class="style-7-upvote-section">
						...
						<?php if( $upvote == 'on' ) : ?>
							...
							<!-- upvote section -->
							<div class="upvote-section upvote-section-style-7">
