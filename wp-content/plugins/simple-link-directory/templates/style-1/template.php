<?php wp_enqueue_style('sld-css-style-1', OCOPD_TPL_URL . "/$template_code/template.css" ); ?>
...
?>
		...
		<style>
			...
			#bookmark_list.style-1 .ca-menu li .upvote-section-style1 .upvote-btn, #bookmark_list.ca-menu li .upvote-section-style1 .upvote-count{
			  color: <?php echo $conf['list_subtxt_color']; ?>;
			}

			#bookmark_list.style-1 .ca-menu li:hover .upvote-section-style1 .upvote-btn, #bookmark_list.style-1 .ca-menu li:hover .upvote-section-style1 .upvote-count{
			  color: <?php echo $conf['list_subtxt_color_hov']; ?>;
			}
...
//adding extra variable in config
		...
		<style>
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-1 .ca-menu li {
			    border-left: 10px solid <?php echo $conf['list_border_color']; ?>;
			    background-color: <?php echo $conf['list_bg_color']; ?>;
				box-shadow: 1px 1px 2px <?php echo $conf['item_bdr_color']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-1 .ca-menu li:hover {
			    background-color: <?php echo $conf['list_bg_color_hov']; ?>;
				color: <?php echo $conf['list_txt_color_hov']; ?>;
				box-shadow: 1px 1px 2px <?php echo $conf['item_bdr_color_hov']; ?>;
			}
			...
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-1 .ca-menu li:hover .ca-main {
			  color: <?php echo $conf['list_txt_color_hov']; ?>;
			}
			...
			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-1 .ca-menu li:hover .ca-sub {
			  color: <?php echo $conf['list_subtxt_color_hov']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-1 .ca-menu li .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?> .ca-menu li .upvote-section .upvote-count{
			  color: <?php echo $conf['list_subtxt_color']; ?>;
			}

			#qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-1 .ca-menu li:hover .upvote-section .upvote-btn, #qcopd-list-<?php echo $listId .'-'. get_the_ID(); ?>.style-1 .ca-menu li:hover .upvote-section .upvote-count{
			  color: <?php echo $conf['list_subtxt_color_hov']; ?>;
			}
				...
				<ul class="ca-menu" id="jp-list-<?php echo get_the_ID(); ?><?php echo (isset($cattabid)&&$cattabid!=''?'-'.$cattabid:''); ?>">
					...
					<li id="item-<?php echo get_the_ID() ."-". $count; ?>">
						...
						<?php if( $upvote == 'on' ) : ?>
							...
							<!-- upvote section -->
							<div class="upvote-section upvote-section-style1">
