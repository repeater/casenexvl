			...
			<tbody>
				...
				<tr valign="top">
					...
					<td>
						...
						<label for="enabled">
                        <input <?php if ($config->all_caching_disabled_forced) { ?>disabled <?php } ?>type="checkbox" name="all_caching_disabled" value="1" <?php if ($config->all_caching_disabled) { echo 'checked="1"'; } ?> />  All Caching Disabled</label>
                        ...
                        <?php if ($config->all_caching_disabled_forced) { ?><p class="description"><b>This option has been configured by the PAGELY_CACHE_DISABLE_ALL constant, see wp-config.php to change it.</p><?php } ?>
